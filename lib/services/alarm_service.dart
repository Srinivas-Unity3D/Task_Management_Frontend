...
//       print('[AlarmService] Initialized successfully');
//     } catch (e, stackTrace) {
//       print('[AlarmService] Initialization failed: $e\n$stackTrace');
//     }
//   }
//
...
//         print('[AlarmService] Alarm time $alarmTime is in the past, skipping');
//         return;
//       }
//
//       final alarmSettings = AlarmSettings(
//         id: alarmId.hashCode, // Unique ID based on alarmId
//         dateTime: alarmTime,
...
//         androidStopAlarmOnTermination: false, // Ensure alarm persists
//
//       );
//
//       await Alarm.set(alarmSettings: alarmSettings);
//       print('[AlarmService] Alarm scheduled for $alarmTime (Task: $taskTitle, ID: $taskId, Alarm ID: $alarmId)');
//     } catch (e, stackTrace) {
